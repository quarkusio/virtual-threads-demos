...
import org.acme.pulsar.accounts.AccountRepository;
import org.acme.pulsar.models.Transaction;
...
public class TransactionGenerationResource {
	 ...
	 * It does not wait for the message to be acknowledged by Pulsar.
	 *
